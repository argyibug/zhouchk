...
const publications = [
  {
    title: "Spin excitations arising from anisotropic Dirac spinons in YCu3(OD)6Br2[Br0.33(OD)0.67]\\(\\mathrm{YCu}_3(\\mathrm{OD})_6\\mathrm{Br}_2[\\mathrm{Br}_(\\mathrm{OD})_{1-x}]\\)",
